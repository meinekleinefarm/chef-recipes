...
%w{ 1.9.3-p484 2.0.0-p353 2.1.0 }.each do |version_name|

  rbenv_ruby version_name do
    ruby_version version_name
    global true
  end
...
application "mkf_staging" do
  ...
  symlink_before_migrate      "database.yml" => "config/database.yml", "memcached.yml" => "config/memcached.yml", "gattica.yml" => "config/gattica.yml"
